 ...
 * post de sus amigos. Tambien puede hacer like de en un comentario.
 *
...
class Comment {
   ...
   * @param User $author El autor del comentario
   * @param Post $post El post relativo al comentario
   */
  public function __construct($id=NULL, $date=NULL, $content=NULL, $numLikes=NULL, User $author=NULL, Post $post=NULL,Like $likes) {
    $this->id = $id;
	$this->date = $date;
  ...
  /**
   * Enlaza los likes en el comentario
   * @param array $likes
   */
	public function setLikes(array $likes){
		$this->likes = $likes;
