...
class CommentDAO {
	...
	*
	* @param Comment $coment El comentario a ser guardado
	...
	*/
	public function save(Comment $comment){
		...
		$stmt->execute(array($comment->getDate(),$comment->getContent(),$comment->getNumLikes(),$comment->getAuthor(),$comment->getIdPost()));
	}
}
?>